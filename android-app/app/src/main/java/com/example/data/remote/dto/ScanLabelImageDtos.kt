...
data class IngredientDto(
    ...
    val riskAssessmentAvailable: Boolean? = null,
    val riskRationale: String? = null,
    val efsaApprovalStatus: String? = null,
    val fdaApprovalStatus: String? = null,
    val adiMinMgPerKgBwPerDay: Double? = null,
    ...
    companion object {
        ...
        fun fromJson(json: JSONObject): IngredientDto {
            return IngredientDto(
                ...
                riskAssessmentAvailable = json.optNullableBoolean("riskAssessmentAvailable"),
                riskRationale = json.optString("riskRationale").takeIf { it.isNotBlank() },
                efsaApprovalStatus = json.optString("efsaApprovalStatus").takeIf { it.isNotBlank() },
                fdaApprovalStatus = json.optString("fdaApprovalStatus").takeIf { it.isNotBlank() },
                adiMinMgPerKgBwPerDay = json.optNullableDouble("adiMinMgPerKgBwPerDay"),
                ...
                summaryJson = json.optJSONObject("summary")?.toString(),
                ...
                isVegetarian = json.optNullableBoolean("isVegetarian"),
                isHalal = json.optNullableBoolean("isHalal"),
                isKosher = json.optNullableBoolean("isKosher"),
...
fun List<IngredientDto>.toEntities(idPrefix: String): List<IngredientEntity> =
    mapIndexed { index, ing ->
        ...
        IngredientEntity(
            id = ingId,
            commonName = ing.commonName.cleanOrNull() ?: "Recognized ingredient",
            ...
            countriesRestrictedOrBanned = ing.countriesRestrictedOrBanned ?: "",
            efsaStatus = ing.efsaStatus ?: "",
            fdaStatus = ing.fdaStatus ?: "",
            whoIarcClassification = ing.whoIarcClassification,
            acceptableDailyIntake = ing.acceptableDailyIntake ?: "",
            sideEffects = ing.sideEffects ?: "",
            allergens = ing.allergens ?: "",
            references = ing.references ?: "",
            riskLevel = parseRiskLevel(ing.riskLevel),
            riskAssessmentAvailable = ing.riskAssessmentAvailable ?: false,
            riskRationale = ing.riskRationale.cleanOrNull(),
            efsaApprovalStatus = ing.efsaApprovalStatus.cleanOrNull(),
            fdaApprovalStatus = ing.fdaApprovalStatus.cleanOrNull(),
            adiMinMgPerKgBwPerDay = ing.adiMinMgPerKgBwPerDay,
